...
| `config_path` | Path to release configuration file | ❌ | `.github/release-config.yml` |
...
Create a `.github/release-config.yml` file in your repository with the following structure:
    ...
    steps:
      ...
      - name: Create release artifacts
        ...
        with:
          ...
          github_token: ${{ secrets.GITHUB_TOKEN }}
          config_path: '.github/custom-release-config.yml'
